            ...
            <td style="width: 50%; vertical-align: top;">
                ...
                <table class="content-table">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $registration->no_telp_ayah }}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: bold;">NO HP Ibu</td>
                        <td>:</td>
                        <td>{{ $registration->no_telp_ibu }}</td>
                    </tr>
                </table>
                ...
                <div>
                    ...
                    <p class="info-text">Email: {{ $registration->email }}</p>
                    <p class="info-text">Password: {{ $registration->nisn }}</p>
